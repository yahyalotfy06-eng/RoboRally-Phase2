...
void RebootRepairAction::Execute()
{
	...
	pGrid->PrintErrorMessage("Rebooting player... You lose 1 HP. Click to continue ...");
	...
	{
		pGrid->PrintErrorMessage("Player has no health left after reboot! Game over. Click to continue ...");
	...
	pGrid->PrintErrorMessage("Reboot complete! Player returned to start. Click to continue ...");
}
